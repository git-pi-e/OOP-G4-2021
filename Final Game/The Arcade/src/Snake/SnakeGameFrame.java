...
public class SnakeGameFrame extends JPanel implements KeyListener {
    ...
    public void paint(Graphics g) {
        ...
        if(!gameOver) {
            ...
            g.drawString("Game Over", SnakeGameFrame.SCREEN_WIDTH / 2, SnakeGameFrame.SCREEN_HEIGHT / 2);
            g.drawString("Score: " + apple.getScore(), SnakeGameFrame.SCREEN_WIDTH / 2, SnakeGameFrame.SCREEN_HEIGHT / 2 + font_size*2);
        }
